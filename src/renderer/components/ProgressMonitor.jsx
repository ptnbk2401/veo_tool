...
function ProgressMonitor() {
  const { activeJobs, currentProgress, logs, pauseJob, resumeJob, stopJob, clearLogs } = useAppStore()
        ...
        <>
              ...
              <div>
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`status ${getStatusColor(selectedJob.status)}`}>
                      {selectedJob.status}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      {selectedJob.startedAt ? formatDuration(selectedJob.startedAt) : 'Not started'}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">Total Items</div>
                    <div className="font-medium">{selectedJob.progress?.total || 0}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">Current Item</div>
                    <div className="font-medium text-sm">
                      {selectedJob.progress?.current?.Prompt?.substring(0, 30) || 'None'}...
                    </div>
                  </div>
                </div>
          ...
          {currentProgress && (
            <div className="card">
              ...
              <div className="mb-2">
                <div className="text-sm text-gray-500">Item ID: {currentProgress.itemId}</div>
                <div className="font-medium mb-2">{currentProgress.progress?.message || 'Processing...'}</div>
