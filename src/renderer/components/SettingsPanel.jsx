        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="form-group">
                ...
                <div className="text-sm text-gray-500">
                  How often to check render progress
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                />
                <div className="text-sm text-gray-500">
                  Maximum time to wait for render
                </div>
              </div>
            ...
            <div className="form-group">
              ...
              <div className="text-sm text-gray-500">
                Run browser in background (not recommended for debugging)
              </div>
            </div>
          </div>
            ...
            <div className="form-group">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("paths", "outputFolder", e.target.value)
                  }
                />
                <button
            ...
            <div className="form-group">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("paths", "logsFolder", e.target.value)
                  }
                />
                <button
                  className="btn btn-outline"
              ...
              <div className="text-sm text-gray-500">
                Where application logs will be stored
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleSettingChange("ui", "logLevel", e.target.value)
                  }
                >
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("ui", "autoSave", e.target.checked)
                  }
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("ui", "notifications", e.target.checked)
                  }
                />
