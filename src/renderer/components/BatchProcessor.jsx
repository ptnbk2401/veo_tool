...
function BatchProcessor() {
  const { profiles, selectedProfile, setSelectedProfile, startJob } =
    useAppStore();
        ...
        <div className="form-group">
          ...
          <div className="flex gap-2">
            <input
              ...
              readOnly
            />
            <button className="btn btn-outline" onClick={handleFileSelect}>
              Browse
            </button>
          </div>
          <div className="text-sm text-gray-500 mt-2">
      ...
      <div className="card">
        ...
        <div className="text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-600">
            <li>
              <strong>ID</strong>: Unique identifier for each video
            </li>
            <li>
              <strong>Prompt</strong>: Description for video generation
            </li>
            <li>
              <strong>Flow_URL</strong>: VEO Flow project URL
            </li>
            <li>
              <strong>Status</strong>: pending, rendering, done, or error
            </li>
          </ul>
