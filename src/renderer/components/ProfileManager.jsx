...
function ProfileManager({ onProfileSelected }) {
  ...
  const handleCreateProfile = async () => {
    ...
    try {
      ...
      alert(`Profile "${profile.name}" created successfully!\n\nNext step: Login to Google Flow`);
    } catch (error) {
        ...
        <div className="modal-overlay" onClick={() => setShowCreateModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-description">
              This will create a new isolated Chrome profile for VEO3 automation.
              Your personal Chrome data will not be affected.
            </p>
