    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="text-sm text-gray-600">
            Configure VEO3 video generation parameters
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleVideoSettingChange("model", e.target.value)
              }
            >
            ...
            <p className="form-help">
              VEO 3.1 Fast provides faster generation with good quality
            </p>
          </div>
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleVideoSettingChange("aspectRatio", e.target.value)
              }
            >
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleVideoSettingChange("count", parseInt(e.target.value))
              }
            >
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleVideoSettingChange("duration", e.target.value)
              }
            >
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleVideoSettingChange("quality", e.target.value)
              }
            >
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="text-sm text-gray-600">
            Configure automation behavior and performance
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-group">
            ...
            />
            <p className="form-help">
              Maximum time to wait for video rendering
            </p>
          </div>
          ...
          <div className="form-group">
            ...
            />
            <p className="form-help">
              Number of retry attempts for failed renders
            </p>
          </div>
      ...
      <div className="flex gap-3 justify-end">
        <button className="btn btn-outline" onClick={handleResetToDefaults}>
          Reset to Defaults
        </button>
        <button
